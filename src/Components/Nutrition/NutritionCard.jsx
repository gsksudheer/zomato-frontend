        ...
        <div className="w-full p-4 md:w-1/2 lg:w-1/3">
            <div className="bg-white rounded-2xl shadow-lg ">
                <div className={`w-full h-56 bg-${props.bg}-100 rounded-t-2xl`}>
                    <img src={props.image} alt="Nutri" className="w-full h-full "/>
                </div>
            <div className="p-3 flex flex-col gap-3">
               ...
               <p className="text-sm font-light text-gray-400"> This formula with VFill™ technology will help improve metabolism and
                  support fat burn.
                </p>
                <div className="mt-4">
                    <hr />
                ...
                <span>
                    <s className="text-gray-400 font-light mr-4">₹500</s>
                    <strong>₹320</strong>
                </span>
...
/* 
 ...
 https://dote.zmtcdn.com/prod/data/admin_assets/images/985/1db983abf8a38bdebb42171b5ea7d985_1614756360.png?output-format=webp
  import React from "react";
import { BsStarFill, BsStarHalf, BsStar } from "react-icons/bs";
import ReactStars from "react-rating-stars-component";
